...
// (internal/codepush/client.go). Trimmed to the push-path subset of the Client interface (see
// types.go); the X-Bitrise-User-Agent identity string was changed from "codepush-cli/<version>" to
// "bitrise-codepush-step/<version>" to identify requests made by this Step.
package codepush
